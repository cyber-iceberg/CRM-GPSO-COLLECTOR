...
export const BLOQUES = [
  {
    ...
    items: [
      { t: "El VIN coincide con el coche y la documentación", pen: 3, rojo: true, mal: "El VIN no coincide entre coche y documentación", obs: "VIN a verificar con más calma", tip: {
      ...
      { t: "Teil I disponible", pen: 1, mal: "Falta el Teil I (permiso de circulación)", obs: "Teil I pendiente de confirmar", tip: {
      ...
      { t: "Teil II disponible", pen: 2, rojo: true, mal: "Falta el Teil II (ficha técnica): complica la importación", obs: "Teil II pendiente de aportar", tip: {
      ...
      { t: "CoC disponible o verificable", pen: 1, mal: "Sin CoC: coste y trámite de homologación añadidos", obs: "CoC pendiente de conseguir", tip: {
      ...
      { t: "Historial de mantenimiento disponible", pen: 1, mal: "Sin historial de mantenimiento fiable", obs: "Historial incompleto, a revisar", tip: {
      ...
      { t: "Facturas o pruebas de mantenimiento", pen: 1, mal: "Faltan facturas que respalden el mantenimiento", obs: "Facturas escasas o desordenadas", tip: {
      ...
      { t: "Kilometraje coherente con historial y estado", pen: 3, rojo: true, mal: "Kilometraje incoherente con el estado real: posible manipulación", obs: "Kilometraje a contrastar con centralita", tip: {
      ...
      { t: "Número de propietarios coherente", pen: 1, mal: "Número de propietarios llamativo para la edad del coche", obs: "Nº de propietarios a aclarar", tip: {
      ...
      { t: "Sin incoherencias claras en la documentación", pen: 3, mal: "Incoherencias entre documentación, anuncio y coche", obs: "Algún dato documental a cuadrar", tip: {
      ...
      { t: "Sin datos sospechosos o información poco clara", pen: 2, mal: "Información documental poco clara o vendedor evasivo", obs: "Vendedor poco transparente con los papeles", tip: {
  ...
  },
  {
    ...
    items: [
      { t: "Pintura visualmente uniforme", pen: 1, mal: "Pintura no uniforme: zonas repintadas", obs: "Ligera falta de uniformidad en la pintura", tip: {
      ...
      { t: "Sin diferencias de tono entre piezas", pen: 2, mal: "Diferencia de tono entre piezas: repintado", obs: "Leve diferencia de tono a vigilar", tip: {
      ...
      { t: "Sin golpes fuertes visibles", pen: 2, mal: "Golpe importante visible en la carrocería", obs: "Golpe menor a valorar", tip: {
      ...
      { t: "Sin abolladuras importantes", pen: 1, mal: "Abolladura importante en carrocería", obs: "Pequeña abolladura de uso", tip: {
      ...
      { t: "Sin arañazos graves", pen: 1, mal: "Arañazos graves: coste de pintura", obs: "Arañazos leves de uso", tip: {
      ...
      { t: "Paragolpes delantero correcto", pen: 1, mal: "Paragolpes delantero con señales de desmontaje o golpe", obs: "Paragolpes delantero repintado", tip: {
      ...
      { t: "Paragolpes trasero correcto", pen: 1, mal: "Paragolpes trasero con señales de desmontaje o golpe", obs: "Paragolpes trasero repintado", tip: {
      ...
      { t: "Ajustes de puertas, capó y maletero", pen: 2, mal: "Holguras desiguales: indicio de golpe reparado", obs: "Ajuste de holguras mejorable", tip: {
      ...
      { t: "Sin holguras raras entre piezas", pen: 2, mal: "Holguras irregulares y tornillería marcada: piezas desmontadas", obs: "Alguna holgura a revisar", tip: {
      ...
      { t: "Faros y pilotos en buen estado", pen: 1, mal: "Faro de fecha incoherente: posible golpe en ese frontal", obs: "Faro con desgaste u opacidad", tip: {
      ...
      { t: "Lunas sin daños importantes", pen: 1, mal: "Luna dañada o cambiada sin explicación", obs: "Pequeña marca en una luna", tip: {
      ...
      { t: "Bajos sin golpes preocupantes", pen: 1, mal: "Golpes preocupantes en los bajos", obs: "Roces normales en bajos", tip: {
      ...
      { t: "Sin señales claras de reparación deficiente", pen: 2, rojo: true, mal: "Reparación deficiente visible (masilla, lijado, sobrepulverización)", obs: "Algún detalle de reparación a mirar", tip: {
  ...
  },
  {
    ...
    items: [
      { t: "Sin señales claras de golpe estructural", pen: 3, rojo: true, mal: "Señales de golpe estructural (larguero/torreta)", obs: "Zona estructural a revisar", tip: {
      ...
      { t: "Sin soldaduras extrañas visibles", pen: 3, rojo: true, mal: "Soldaduras extrañas: chapa cortada y unida", obs: "Soldadura a examinar", tip: {
      ...
      { t: "Sin deformaciones en zonas críticas", pen: 2, mal: "Deformación o asimetría en zona crítica", obs: "Ligera asimetría a confirmar", tip: {
      ...
      { t: "Frontal con aspecto coherente", pen: 2, mal: "Frontal con señales de golpe (chapa nueva, masilla)", obs: "Frontal con algún detalle a mirar", tip: {
      ...
      { t: "Trasera con aspecto coherente", pen: 2, mal: "Trasera con señales de golpe reparado", obs: "Trasera con detalle a confirmar", tip: {
      ...
      { t: "Maletero sin señales raras de reparación", pen: 1, mal: "Suelo de maletero con reparación no original", obs: "Maletero con detalle a revisar", tip: {
      ...
      { t: "Suelo y bajos sin daños preocupantes", pen: 1, mal: "Daños en suelo o bajos", obs: "Bajos con detalle a vigilar", tip: {
      ...
      { t: "Sin corrosión importante", pen: 2, rojo: true, mal: "Corrosión importante en zona estructural", obs: "Óxido a vigilar", tip: {
      ...
      { t: "Sin reparaciones mal ejecutadas en zona estructural", pen: 1, mal: "Reparación mal ejecutada en zona estructural: compromete seguridad", obs: "Reparación estructural a verificar", tip: {
      ...
      { t: "Sin indicios de bancada o reconstrucción seria", pen: 1, rojo: true, mal: "Indicios de bancada / reconstrucción seria", obs: "Posible paso por bancada a confirmar", tip: {
  ...
  },
  {
    ...
    items: [
      { t: "Arranque en frío realizado", pen: 2,
        campo: { tipo: "opciones", label: "¿Pudiste arrancarlo en frío?", opciones: ["Sí, en frío", "Ya estaba caliente", "Pedí vídeo"] }, mal: "No se pudo verificar el arranque en frío", obs: "Arranque en frío pendiente de confirmar", tip: {
      ...
      { t: "Arranca con normalidad", pen: 1, mal: "Arranque dificultoso", obs: "Arranque algo lento", tip: {
      ...
      { t: "Ralentí estable", pen: 2, mal: "Ralentí inestable", obs: "Ralentí ligeramente irregular", tip: {
      ...
      { t: "Sin ruidos anómalos claros", pen: 2, rojo: true, mal: "Ruidos anómalos en el motor (posible interno)", obs: "Ruido de motor a vigilar", tip: {
      ...
      { t: "Sin humos anormales", pen: 2, rojo: true, mal: "Humos anormales en el escape", obs: "Humo leve a vigilar", tip: {
      ...
      { t: "Sin fugas visibles", pen: 2, mal: "Fuga visible en el motor", obs: "Zona húmeda a vigilar", tip: {
      ...
      { t: "Temperatura de funcionamiento correcta", pen: 1, mal: "Problema de temperatura / refrigeración", obs: "Temperatura a vigilar", tip: {
      ...
      { t: "Respuesta al acelerar limpia", pen: 1, mal: "Respuesta irregular al acelerar", obs: "Respuesta algo perezosa", tip: {
      ...
      { t: "Sin testigos encendidos", pen: 1, rojo: true, mal: "Testigo de avería encendido", obs: "Testigo a revisar con diagnosis", tip: {
  ...
  },
  {
    ...
    items: [
      { t: "Amortiguadores sin fugas ni vencidos", pen: 2, mal: "Amortiguadores con fuga o vencidos", obs: "Amortiguación algo cansada", tip: {
      ...
      { t: "Correa de distribución / cadena en fecha", pen: 3, rojo: true, mal: "Distribución sin cambio demostrable: coste grande o riesgo de rotura", obs: "Distribución a confirmar con factura", tip: {
      ...
      { t: "Silentblocks y gomas sin roturas", pen: 1, mal: "Silentblocks o gomas rotos", obs: "Gomas a vigilar", tip: {
      ...
      { t: "Rótulas y bieletas sin holgura", pen: 2, mal: "Holgura en rótulas o bieletas: suspenso de ITV", obs: "Rótulas/bieletas a vigilar", tip: {
      ...
      { t: "Sin fugas en caja de cambios / diferencial", pen: 2, mal: "Fuga en caja de cambios o diferencial", obs: "Zona a vigilar por posible fuga", tip: {
      ...
      { t: "Latiguillos y tubos de freno en buen estado", pen: 1, mal: "Latiguillos o tubos de freno en mal estado: seguridad", obs: "Latiguillos a vigilar", tip: {
      ...
      { t: "Escape completo y sin fugas", pen: 1, mal: "Escape dañado o catalizador retirado", obs: "Escape con detalle a revisar", tip: {
      ...
      { t: "Sin óxido perforante en bajos", pen: 1, mal: "Óxido perforante en los bajos", obs: "Óxido superficial a vigilar", tip: {
      ...
      { t: "Sin ruidos o juegos anómalos en tren rodante", pen: 1, mal: "Rodamientos o holguras en el tren rodante", obs: "Ruido de rodadura a vigilar", tip: {
  ...
  },
  {
    ...
    fotos: [],
    items: [
      { t: "Entrada de marcha correcta", pen: 1, mal: "Entrada de marcha con golpe o retardo", obs: "Entrada de marcha algo brusca", tip: {
      ...
      { t: "Sin golpes secos al meter D o R", pen: 2, rojo: true, mal: "Golpe seco al meter marcha: caja tocada", obs: "Leve toque al meter marcha", tip: {
      ...
      { t: "Sin retardo anómalo al seleccionar marcha", pen: 1, mal: "Retardo evidente al seleccionar marcha", obs: "Ligero retardo al meter marcha", tip: {
      ...
      { t: "Cambios suaves en conducción", pen: 1, mal: "Cambios bruscos o patinando", obs: "Cambios poco finos", tip: {
      ...
      { t: "Sin tirones entre marchas", pen: 1, mal: "Tirones repetidos entre marchas", obs: "Algún tirón puntual", tip: {
      ...
      { t: "Sin vibraciones anómalas al acelerar", pen: 1, mal: "Vibración fuerte al acelerar (transmisión)", obs: "Vibración leve a vigilar", tip: {
      ...
      { t: "Marcha atrás correcta", pen: 1, mal: "Marcha atrás con ruido o problema", obs: "Marcha atrás a vigilar", tip: {
      ...
      { t: "Embrague sano si es manual", pen: 1, mal: "Embrague patinando: coste seguro", obs: "Embrague con tacto mejorable", tip: {
  ...
  },
  {
    ...
    fotos: [],
    items: [
      { t: "Sin ruidos ni golpes secos en suspensión", pen: 1, mal: "Golpes secos en suspensión (amortiguador/silentblock/rótula)", obs: "Ruido leve en suspensión", tip: {
      ...
      { t: "Sin crujidos al girar", pen: 1, mal: "Crujido al girar (homocinética o rótula)", obs: "Crujido puntual a vigilar", tip: {
      ...
      { t: "Dirección estable y precisa", pen: 2, rojo: true, mal: "Dirección imprecisa o con holgura: seguridad", obs: "Dirección algo mejorable", tip: {
      ...
      { t: "El coche mantiene la trayectoria", pen: 1, mal: "El coche se va de lado (alineación o algo mayor)", obs: "Ligera desviación a revisar", tip: {
      ...
      { t: "Sin vibraciones claras en el volante", pen: 1, mal: "Vibración clara en el volante", obs: "Vibración leve en volante", tip: {
      ...
      { t: "Frenada recta y estable", pen: 2, rojo: true, mal: "Frenada inestable: peligrosa", obs: "Frenada con detalle a revisar", tip: {
      ...
      { t: "Sin vibración clara al frenar", pen: 1, mal: "Vibración al frenar: discos alabeados", obs: "Leve vibración al frenar", tip: {
      ...
      { t: "Sin sensación de inseguridad en marcha", pen: 1, mal: "Tren rodante cansado: falta de aplomo", obs: "Sensación algo floja a vigilar", tip: {
  ...
  },
  {
    ...
    fotos: [],
    items: [
      { t: "Dibujo suficiente y uniforme en las 4 ruedas", pen: 1, mal: "Neumáticos gastados o desiguales", obs: "Neumáticos cerca del cambio", tip: {
      ...
      { t: "Sin desgaste raro por interior o exterior", pen: 1, mal: "Desgaste irregular: geometría o suspensión", obs: "Desgaste algo irregular a vigilar", tip: {
      ...
      { t: "DOT razonable y medidas correctas", pen: 1, mal: "Neumáticos viejos o de medida incorrecta", obs: "DOT algo antiguo", tip: {
      ...
      { t: "Misma lógica de neumáticos en el conjunto", pen: 1, mal: "Cuatro neumáticos dispares: mantenimiento descuidado", obs: "Neumáticos no homogéneos", tip: {
      ...
      { t: "Llantas sin daños graves ni deformación", pen: 1, mal: "Llanta deformada o agrietada", obs: "Roce estético en llanta", tip: {
  ...
  },
  {
    ...
    items: [
      { t: "Volante, asiento y tapicería coherentes con los km", pen: 1, mal: "Desgaste interior incoherente con los km: posible manipulación", obs: "Interior con desgaste a valorar", tip: {
      ...
      { t: "Botones, mandos y pantallas funcionando", pen: 1, mal: "Fallo en equipamiento (clima, pantalla u otros)", obs: "Algún mando a revisar", tip: {
      ...
      { t: "Extras anunciados coinciden con la realidad", pen: 1, mal: "Extras anunciados que no están o no funcionan", obs: "Algún extra a confirmar", tip: {
      ...
      { t: "Llaves disponibles según lo prometido", pen: 1,
        campo: { tipo: "numero", label: "Nº de llaves", placeholder: "2" }, mal: "Falta una llave: coste y resta de valor", obs: "Nº de llaves a confirmar", tip: {
  ...
  },
  {
    ...
    items: [
      { t: "Diagnosis realizada", pen: 1,
        campo: { tipo: "opciones", label: "¿Se hizo diagnosis?", opciones: ["Sí", "No"] }, mal: "Sin diagnosis: peritación incompleta en electrónica", obs: "Diagnosis pendiente de hacer", tip: {
      ...
      { t: "Sin errores graves activos (motor, caja, emisiones)", pen: 1, rojo: true, mal: "Errores activos graves en diagnosis (motor/caja/emisiones)", obs: "Errores históricos a revisar", tip: {
      ...
      { t: "Batería, testigos y sistemas coherentes", pen: 1, mal: "Batería o sistemas electrónicos con problemas", obs: "Algún parámetro electrónico a vigilar", tip: {
  ...
  },
  {
    ...
    fotos: [],
    items: [
      { t: "Sale, acelera y responde limpio", pen: 1, mal: "Respuesta irregular en marcha (tirones/vacíos)", obs: "Respuesta algo mejorable en marcha", tip: {
      ...
      { t: "Dirección, frenada y cambio coherentes en marcha", pen: 1, rojo: true, mal: "Dirección o frenada inseguras en marcha", obs: "Comportamiento en marcha a confirmar", tip: {
      ...
      { t: "Sin ruidos ni testigos nuevos al rodar, temperatura estable", pen: 1, mal: "Ruidos, testigos o temperatura anómalos al rodar", obs: "Detalle a vigilar en marcha", tip: {
